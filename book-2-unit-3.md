...
# Verbos to go (ir) y to do (hacer) en el pasado simple o past simple

## Cómo funciona

En el pasado, los verbos en inglés no cambian normalmente en la tercera persona, como ocurre en el presente.
...
Igual que en presente, la mayoría de las veces que usamos *to do* en pasado lo usamos como verbo auxiliar.
...
En las oraciones negativas el orden será sujeto, *to do* en
negativo, conjugado, y el verbo que queremos usar,
en infinitivo.

    I did not go to the supermarket. - No fui al supermercado.
...
indicamos ese punto utilizando una locución temporal. Estas son algunas locuciones temporales comunes:
    ...
    on Tuesday - el martes (si usamos el past simple, nuestro interlocutor sabe que nos referimos al martes pasado)

    on Friday night - el viernes por la noche

> *Last* se pronuncia generalmente [læst] en Estados Unidos y [lɑ:st] en Reino Unido.

Examples:

*Yesterday at seven I went to the supermarket.* (Ayer a las siete fui al supermercado).

*On Monday night I went to the park.* (El lunes por la noche fui al parque).

*Last Thursday we went to the gym.* (El jueves pasado fuimos al gimnasio).

# Los meses del año, en inglés

## Los meses del año

    January ['dʒænjuɛri] - enero
    
    February ['fɛbruɛri] - febrero
    ...
    September [sɛp'tɛmbər] - septiembre
    
    October [ɑk'toʊbər] - octubre
    
    November [noʊ'vɛmbər] - noviembre
    
    December [dɪ'sɛmbər] - diciembre
