...
*if* + *past perfect*, seguido de *would have* + participio pasado.
    ...
    If she had taken the train, she wouldn't have been late.
    (Si ella hubiera cogido el tren, no habría llegado tarde).

The action didn't happen. We are imagining a different past.

🔹 La acción no ocurrió. Estamos imaginando un pasado diferente.
...
(Si no hubiera comido tanto, no se habría sentido mal).
...
We can use *could have* or *might have* instead of *would have:*

🔹 Podemos usar *could have* o *might have* en lugar de *would have:*

*If I had arrived earlier, I could have helped.* (Si hubiera llegado antes, podría haber ayudado).
...
## Questions and negative sentences (preguntas y oraciones negativas)
    ...
    If I hadn't moved to this city, I wouldn't have met my wife.
    (Si no me hubiera mudado a esta ciudad, no habría conocido a mi mujer).
...
Sometimes we mix the second and third conditionals. This happens when an imaginary
past action has a present consequence, or vice versa.

🔹 A veces mezclamos el segundo y el tercer condicional. Esto ocurre cuando una acción
imaginaria del pasado tiene una consecuencia presente, o viceversa.

### Past cause, present result (causa pasada, resultado presente)
...
# Life events vocabulary (vocabulario: eventos de la vida)
    ...
    grow up [groʊ ʌp] - crecer

    graduate ['grædʒueɪt] - graduarse

    get married [gɛt 'mærɪd] - casarse

    get divorced [gɛt dɪ'vɔrst] - divorciarse
    ...
    get promoted [prə'moʊtɪd] - ser ascendido

    retire [rɪ'taɪr] - jubilarse

    pass away [pæs ə'weɪ] - fallecer

    celebrate ['sɛləbreɪt] - celebrar

    achieve [ə'tʃi:v] - lograr

    succeed [sək'si:d] - tener éxito

    opportunity [ɑpər'tu:nəti] - oportunidad

    decision [dɪ'sɪʒən] - decisión

    regret [rɪ'grɛt] - arrepentimiento / arrepentirse

# Conversation

Ana: If you could change one thing about your past, what would it be?

David: If I had traveled more when I was young, I would be more open-minded now. I spent
too much time working and not enough time experiencing the world.
...
A: If I hadn't changed jobs in 2018, I wouldn't have met my husband.
So even though that job was terrible, it led [lɛd] (llevó) to something wonderful.

D: Funny how life works. If my parents hadn't moved to Barcelona when I was ten,
I would have grown up in a completely different place. My whole life would have been different.

A: Do you regret anything?

D: If I had learned English earlier, I would have had more opportunities. But
I'm learning now, so it's never too late!

A: That's the right attitude ['ætɪtu:d] (actitud). If we always looked back
with regret, we would never move forward ['fɔrwərd] (hacia delante).
...
## 1. Complete, using the third conditional

🔹 Completar, usando el tercer condicional.

1. If I __________ (know) about the party, I __________ (go).
2. If she __________ (not / miss) the bus, she __________ (arrive) on time.
3. If we __________ (leave) earlier, we __________ (not / be) late.
4. If he __________ (study) harder, he __________ (pass) the exam.
5. If it __________ (not / rain), we __________ (have) the picnic outside.
6. If they __________ (invite) me, I __________ (come).

## 2. Choose between first, second, and third conditional
