...
When we tell someone what another person said, we use reported speech (also called
indirect speech). In Spanish, this works in a very similar way.

🔹 Cuando le contamos a alguien lo que otra persona dijo, usamos el estilo indirecto
(*reported speech*). En español, esto funciona de manera muy similar.
...
# Communication vocabulary (vocabulario: comunicación)
    ...
    conversation [kɑnvər'seɪʃən] - conversación

    argument ['ɑrgjumənt] - discusión

    discussion [dɪ'skʌʃən] - debate / discusión

    opinion [ə'pɪnjən] - opinión

    agree [ə'gri:] - estar de acuerdo

    disagree [dɪsə'gri:] - no estar de acuerdo

    suggest [sə'dʒɛst] - sugerir

    advise [əd'vaɪz] - aconsejar

    complain [kəm'pleɪn] - quejarse

    apologize [ə'pɑlədʒaɪz] - disculparse

    explain [ɪk'spleɪn] - explicar

    convince [kən'vɪns] - convencer

    persuade [pər'sweɪd] - persuadir

    interrupt [ɪntə'rʌpt] - interrumpir

    whisper ['wɪspər] - susurrar

    shout [ʃaʊt] - gritar

    mention ['mɛnʃən] - mencionar

    promise ['prɑmɪs] - prometer

# Conversation

Marta: I talked to Pedro yesterday.

Carlos: What did he say?

M: He said he was thinking about moving to London. He told me he had found
a job there.

C: Really? Did he say when he was going to move?

M: He said he would move in September. He asked me if I wanted to visit him.
...
M: He asked me to help him find a good neighborhood in London.
